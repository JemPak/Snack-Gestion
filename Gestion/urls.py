...
urlpatterns = [
    ...
    path('contact/user/<int:user_id>/<str:active>', contact.contactView.Contact_User.as_view()),       #list contacts by user id    
    ...
    path('installation/user/<int:user_id>/<str:active>', install.installationView.Installation_User.as_view()), 
]
